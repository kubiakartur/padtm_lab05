...
public class MySQLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database) {
        String DATABASE_CREATE = "create table animals " + "(_id integer primary key autoincrement,"+
                ...
                "opis text not null);"; database.execSQL(DATABASE_CREATE);
    }
    ...
    public Animal pobierz(int id) {
        ...
        Cursor cursor = db.query("animals", new String[] { "_id", "gatunek", "kolor", "wielkosc", "opis"},
